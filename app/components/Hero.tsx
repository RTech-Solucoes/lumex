      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Aumente suas{' '}
              <span className="bg-gradient-to-r from-[#5b43e6] to-[#f5503d] bg-clip-text text-transparent">
                Vendas Online
              </span>{' '}
              e Presença Digital
            </motion.h1>
            ...
            >
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-transparent border border-[#5b43e6] text-[#5b43e6] px-8 py-4 rounded-full font-semibold hover:bg-[#5b43e6]/10 transition-all duration-300"
              >
